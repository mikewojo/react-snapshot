...
exports.default = function () {
  ...
  }(pkg.homepage ? pkg.homepage !== '.' && pkg.homepage !== './' ? _url2.default.parse(pkg.homepage).pathname : '/' : '');
  ...
  var server = new _Server2.default(buildDirPath, basename, 0, pkg.proxy, pkg.homepage);
